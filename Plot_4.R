...
plot(Cons_Subset$DateTime, as.numeric(Cons_Subset$Global_active_power), type = "l", xlab = "", ylab = "Global Active Power")

plot(Cons_Subset$DateTime, as.numeric(Cons_Subset$Voltage), type = "l", xlab = "datetime", ylab = "Voltage")

plot(Cons_Subset$DateTime, as.numeric(Cons_Subset$Sub_metering_1), type = "l", xlab = "", ylab = "Energy Sub metering")
...
plot(Cons_Subset$DateTime, as.numeric(Cons_Subset$Global_reactive_power), type = "l", xlab = "datetime", ylab = "Global_reactive_power")
